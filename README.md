...
![server view upon successful connection; initials appear with greeting from server "hey"]('/snakeconnect.png')
![server view of best snake player in the game, sending a message to the server that they are winning]('/snakewinning.png")
